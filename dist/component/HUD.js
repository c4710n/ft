...
var HUD = /*#__PURE__*/function (_Component) {
  ...
  function HUD() {
    ...
    _this.system = app.systems.hud;
    _this.name = _this.system.name;
    var left = options.left,
        right = options.right,
        top = options.top,
        bottom = options.bottom;
    if (left !== undefined) _this.left = left;
    if (right !== undefined) _this.right = right;
    if (top !== undefined) _this.top = top;
    if (bottom !== undefined) _this.bottom = bottom;
    return _this;
