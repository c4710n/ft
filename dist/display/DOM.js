...
var DOM = /*#__PURE__*/function (_Sprite) {
  _inherits(DOM, _Sprite);
  ...
  function DOM() {
    ...
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        layer = _ref$layer === void 0 ? Layer.DOM_INTERACTION : _ref$layer;

    _classCallCheck(this, DOM);

    _this = _super.call(this, Texture.EMPTY);
    _this.layer = layer;
    _this.dom = document.createElement(tag);
    _this.skipFirstUpdate = false;
    return _this;
  }
  ...
  _createClass(DOM, [{
    ...
    key: "renderDOM",
    value: function renderDOM(layer) {
      var dom = this.dom;
