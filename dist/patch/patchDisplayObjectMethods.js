...
function setOrigin(originX, originY) {
  ...
  if (this.anchor) {
    ...
    if (originY === undefined) {
      var _origin = originX;
      this.pivot.x = _origin * this.width / this.scale.x;
      this.pivot.y = _origin * this.height / this.scale.y;
    }
  }
...
function setInteractive() {
  ...
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      includeChildren = _ref.includeChildren;
...
//# sourceMappingURL=patchDisplayObjectMethods.js.map