...
import events from '../../events'; // Use HTML Audio

sound.useLegacy = true;
PIXI.Loader.registerPlugin(SoundLoader);

var SoundSystem = /*#__PURE__*/function (_System) {
  _inherits(SoundSystem, _System);

  var _super = _createSuper(SoundSystem);
  ...
  function SoundSystem() {
    ...
    _this = _super.call(this, 'sound');
    events.show.on(function () {
      sound._context.paused = false;

      sound._context.refreshPaused();
    });
    events.hide.on(function () {
