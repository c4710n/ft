...
export default {
  ...
  createTextInstance(_text, _rootContainerInstance, _internalInstanceHandler) {
    invariant(
      false,
      'PixiFiber does not support text instances. Use `<Text /> component` instead.'
    )
  },
  ...
  commitMount(_instance, _updatePayload, _type, _oldProps, _newProps) {
    // noop
  },
